        ...
        <?php
            ...
            foreach (Config::get('simpleauth.groups') as $key => $value) {
                if($key == 50) $userTypes[$key] = $value['name'];
            }
        ?>
        ...
        <div class="form-group" hidden>
                ...
                <?= Form::select('yearlevel_id', 0, $yearlevel,
                    array('class' => 'form-control')); ?>
        </div>


        <div class="form-group course-list" hidden>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <?php echo Html::anchor($action == 'edit' ? 'account' : Controller_Base::get_prefix() .'users', 'Back', array(
                        'class' => 'btn btn-primary',
                        'style' => 'width:100%')); ?>
                </div>
