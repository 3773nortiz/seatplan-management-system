	...
	<table class="table table-striped attendance" ng-show="noStudent == true">
		...
		<tbody>
			...
			<tr ng-repeat="studList in studLists" id="attendance-list">
				...
				<td align="center" ng-repeat="range in ranges" data-toggle="tooltip" data-placement="top" title="{{getReason(studList, range)}}" class="ng-tooltip">
					{{getStatusValue(studList, range)}}
				</td>
			</tr>
		</tbody>
	</table>
